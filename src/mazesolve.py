...
def main(argv):
    ...
    try:
        ...
        # otherwise, we have algorithms to compare
            ...
            solved = a_star_solved or bfs_solved or dfs_solved
...
if __name__ == "__main__":
    ...
    parser.add_argument('-a', '--algorithm', help="The algorithm you wish to use; may either be 'bfs' (for breadth-"
                                                  "first searching), 'dfs' (depth-first search), or 'a*' (to use the A*"
                                                  " algorithm). If unspecified, uses BFS",
                        default="bfs", choices=["bfs", "dfs", "a*"])
    parser.add_argument('-c', '--compare', choices=["bfs", "dfs", "a*"], help="Compare two or more algorithms and see "
